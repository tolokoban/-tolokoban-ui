...
const lch_1 = __importDefault(require("colord/plugins/lch"));
...
class Color {
    ...
    static fromRGB(red, green, blue, alpha = 1) {
        return new Color((0, colord_1.colord)({
            r: clamp(red) * 255,
            g: clamp(green) * 255,
            b: clamp(blue) * 255,
            a: alpha,
    ...
    static fromLCH(lightness, chroma, hue, alpha = 1) {
        return new Color((0, colord_1.colord)({ l: lightness, c: chroma, h: hue, a: alpha }).toHex());
    }
    ...
    constructor(cssValue) {
        ...
        this.color = (0, colord_1.colord)(cssValue);
    }
    isLight() {
