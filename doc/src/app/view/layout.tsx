...
export default function ViewsLayout({
    ...
    return (
        <ViewPanel display="grid" gridTemplateColumns="auto 1fr" fullsize>
            <ViewPanel
                display="flex"
            ...
            >
                ...
                <Link hash="/view/Tooltip">Tooltip</Link>
                <Link hash="/view/Touchable">Touchable</Link>
            </ViewPanel>
            <ViewPanel color="neutral-5" flex="1 1 auto">
                {children}
            </ViewPanel>
        </ViewPanel>
    )
