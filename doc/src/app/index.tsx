...
const Page11 = React.lazy(() => import("./view/InputText/page"))
const Page14 = React.lazy(() => import("./view/Label/page"))
const Page17 = React.lazy(() => import("./view/Options/page"))
const Page20 = React.lazy(() => import("./view/Panel/page"))
const Page23 = React.lazy(() => import("./view/Read/page"))
const Page26 = React.lazy(() => import("./view/Scroll/page"))
const Page29 = React.lazy(() => import("./view/Slider/page"))
const Page32 = React.lazy(() => import("./view/Spinner/page"))
const Page35 = React.lazy(() => import("./view/Tabs/page"))
const Page38 = React.lazy(() => import("./view/Touchable/page"))
