...
export const ROUTES: Record<RoutePath, string[]> = {
    ...
    "/view/FloatingButton": ["/view/FloatingButton"],
    "/view/InputColor": ["/view/InputColor"],
    "/view/InputFile": ["/view/InputFile"],
    "/view/InputImage": ["/view/InputImage"],
    "/view/InputMultiText": ["/view/InputMultiText"],
    "/view/InputNumber": ["/view/InputNumber"],
